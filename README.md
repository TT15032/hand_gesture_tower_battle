...
`model.pt` は YOLOv8s-seg をベースに学習したカスタムセグメンテーションモデルです。

学習データは手で作る輪っか形状を撮影した画像から構築し、
約350枚の画像に対して手動でセグメンテーションアノテーションを行いました。
各画像について輪っか部分の輪郭を自らトレースし、学習データセットを作成しています。
